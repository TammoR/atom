...
CursorsComponent = React.createClass
  ...
  updateSync: ->
    ...
    @oldState ?= {blinkCursorsOff: null, cursors: {}}
    ...
    # remove cursors
    for id, cursorState of @oldState.cursors
  ...
  updateCursorNode: (id, newCursorState) ->
    ...
    oldCursorState = (@oldState.cursors[id] ?= {top: null, left: null, height: null, width: null})
